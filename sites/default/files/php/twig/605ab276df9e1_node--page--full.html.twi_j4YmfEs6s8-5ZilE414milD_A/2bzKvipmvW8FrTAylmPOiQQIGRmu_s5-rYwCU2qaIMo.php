...
<div class=\"container\">
  ...
  <div class=\"catalogo\">
    ...
    ";
        ...
        ";
          ...
          ";
                // line 12
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_var_dump($this->env, $context, ...[0 => $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "imagen", [], "any", false, false, true, 12), 12, $this->source)]), "html", null, true);
                echo "
          <div class=\"product\">
            <h3>";
                // line 14
            ...
            <img alt=\"";
                // line 16
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "imagen", [], "any", false, false, true, 16), 16, $this->source), "html", null, true);
                echo "\" src=\"";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, call_user_func_array($this->env->getFunction('file_url')->getCallable(), [$this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "imagen", [], "any", false, false, true, 16), 16, $this->source)]), "html", null, true);
                echo "\"/>
            -->
  ...
  <div class=\"footer\">
    ...
    {
        return array (  121 => 35,  113 => 32,  104 => 28,  98 => 25,  95 => 24,  93 => 23,  87 => 20,  83 => 19,  75 => 16,  70 => 14,  65 => 12,  62 => 11,  58 => 10,  53 => 8,  50 => 7,  46 => 6,  39 => 1,);
    }
...
<div class=\"container\">
  ...
  <div class=\"footer\">
    ...
    {
        static $tags = array("for" => 6, "if" => 23);
        static $filters = array("escape" => 8);
        static $functions = array("dump" => 12, "file_url" => 16);
