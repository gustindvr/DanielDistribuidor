    ...
    ";
        ...
        ";
          ...
          <div class=\"product\" data-aos=\"flip-up\">
            ...
            <h3>";
                // line 28
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "product_title", [], "any", false, false, true, 28), 28, $this->source), "html", null, true);
                echo "</h3>
            <div class=\"img_size\">
              <img src=\"";
                // line 30
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "imagen_url", [], "any", false, false, true, 30), 30, $this->source), "html", null, true);
                echo "\" />
            </div>
            <p class=\"footer_product\">
              <strong> Precio: \$";
                // line 33
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "precio", [], "any", false, false, true, 33), 33, $this->source), "html", null, true);
                echo "</strong>
              <strong>Cod: ";
                // line 34
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "codigo", [], "any", false, false, true, 34), 34, $this->source), "html", null, true);
                echo "</strong>
            </p>

            ";
                // line 37
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "oferta", [], "any", false, false, true, 37) == true)) {
                    // line 38
                    echo "              <div class=\"sale\">
                <strong>Oferta: \$</strong>";
                    // line 39
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "oferta", [], "any", false, false, true, 39), 39, $this->source), "html", null, true);
                    echo "
              </div>
            ";
                }
...
";
    ...
    {
        return array (  147 => 49,  139 => 46,  130 => 42,  124 => 39,  121 => 38,  119 => 37,  113 => 34,  109 => 33,  103 => 30,  98 => 28,  93 => 25,  89 => 24,  82 => 22,  79 => 21,  75 => 20,  69 => 16,  57 => 12,  53 => 10,  49 => 9,  39 => 1,);
    }
