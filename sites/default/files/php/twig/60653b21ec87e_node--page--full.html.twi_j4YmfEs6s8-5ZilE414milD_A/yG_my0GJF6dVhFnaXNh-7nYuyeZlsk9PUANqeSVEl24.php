        ...
        ";
          ...
          <div class=\"product\" data-aos=\"flip-up\">
            ...
            <p class=\"footer_product\">
              ...
              ";
                // line 35
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "codigo", [], "any", false, false, true, 35) == true)) {
                    // line 36
                    echo "              <strong>Cod: ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "codigo", [], "any", false, false, true, 36), 36, $this->source), "html", null, true);
                    echo "</strong>
              ";
                }
                // line 38
            ...
            ";
                // line 40
                if ((twig_get_attribute($this->env, $this->source, $context["product"], "oferta", [], "any", false, false, true, 40) == true)) {
                    // line 41
                    echo "              <div class=\"sale\">
                <strong>Oferta: \$</strong>";
                    // line 42
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["product"], "oferta", [], "any", false, false, true, 42), 42, $this->source), "html", null, true);
                    echo "
              </div>
            ";
                }
...
";
    ...
    {
        return array (  154 => 52,  146 => 49,  137 => 45,  131 => 42,  128 => 41,  126 => 40,  122 => 38,  116 => 36,  114 => 35,  110 => 34,  104 => 31,  99 => 29,  94 => 26,  90 => 25,  83 => 23,  80 => 22,  76 => 21,  70 => 17,  58 => 13,  54 => 11,  50 => 10,  39 => 1,);
    }
...
<div class=\"container\">
  ...
  <main class=\"catalogo\">
    ...
    {% for lista_producto in lista_de_productos %}
      <div class=\"marca\"  >
        <h2 id=\"{{ lista_producto[0].marca }}\"><span class=\"title_marca\">{{ lista_producto[0].marca }}</span></h2>
...
", "themes/distribuidora/templates/node-type/node--page--full.html.twig", "/var/www/html/DanielDistribuidor/themes/distribuidora/templates/node-type/node--page--full.html.twig");
    ...
    {
        static $tags = array("for" => 10, "if" => 35);
